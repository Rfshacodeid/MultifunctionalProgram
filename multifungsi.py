...
def display_welcome_message():
    ...
    print(welcome_text)
    time.sleep(1)  # Memberikan jeda waktu untuk animasi
    print(creator_text)
    time.sleep(1)
    print(contact_text)
    time.sleep(1)
...
def konversi_mata_uang():
    ...
    try:
        rate = 15000  # Kurs contoh, bisa diubah sesuai data terbaru
...
def main():
    display_welcome_message()  # Menampilkan animasi teks di awal
    while True:
        display_menu()
